...
<?php endif; ?>
<?php $component->withAttributes([]); ?>COMPLAINT <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <?php if($complaint != ''): ?>
                                <?php if($complaint->complaint_image): ?>
                                    ...
                                    <?php if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                        ...
                                        <p><?php echo e(basename($complaint->complaint_image)); ?></p>
                                    ...
                                    <?php elseif(in_array($fileExtension, ['mp4', 'avi', 'mov', 'wmv'])): ?>
                                        <div class="video-container">
                                            ...
                                            <h1><?php echo e($fileExtension); ?></h1> <!-- Displaying file extension if needed -->
                                        </div>
                                        <p><?php echo e(basename($complaint->complaint_image)); ?></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('components.user-components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\bms\resources\views/user/services/complaint.blade.php ENDPATH**/ ?>