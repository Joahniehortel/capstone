<style>
	* {
	...
	<div class="modal fade" id="verifyAccountModal2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<form action="<?php echo e(route('admin.verify.account')); ?>" method="POST" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
	...
	<?php $__env->stopPush(); ?><?php /**PATH E:\bms\resources\views/components/admin-components/modal/verify-account.blade.php ENDPATH**/ ?>